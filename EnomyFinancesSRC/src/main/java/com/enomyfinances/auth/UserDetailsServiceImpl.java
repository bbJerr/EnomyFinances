...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
         try {
             ...
             System.out.println("Role Name from UserDetailServiceImpl is " + Arrays.toString(roleNames));
             ...
             // You can throw a custom exception or handle it in a way that suits your application
